        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <div className="relative group animate-float">
            ...
            <img
              src={PhotoHero}
              alt="Eliphaz Guetin"
              className="relative w-60 h-72 md:w-80 md:h-96 object-cover rounded-[40%/40%] shadow-2xl transition-transform duration-500 group-hover:scale-105 animate-zoom-in"
            />
          </div>
        </div>
