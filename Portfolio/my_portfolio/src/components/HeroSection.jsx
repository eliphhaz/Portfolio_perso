      ...
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
            ...
            <span className="text-blue-600 opacity-0 animate-fade-in-delay-1 ml-1">
              Pedro
            </span>
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400 ml-2 opacity-0 animate-fade-in-delay-2">
              Machado
            </span>
          </h1>

          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto opacity-0 animate-fade-in-delay-3">
